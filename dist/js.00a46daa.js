...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/jquery.transit/jquery.transit.js":[function(require,module,exports) {
var define;
/*!
...
window.$ = window.jQuery = jquery; // animation plugin

var transit = require("jquery.transit"); // Slider images and slider bg
...
var addBlur = function addBlur(amount) {
  $(".bg-scroller").css({
...
$.each(sliderImg, function (i, item) {
  if ($(sliderImg[i])) {
    // if slider has img, load src
    if ($(sliderImg[i]).attr("src") == '') {
      // if slider img src empty
      $(sliderImg[i]).attr("src", "https://unsplash.it/".concat(window.screen.width, "/").concat(window.screen.height, "?gravity=east?sig=").concat(i)); // Get dynamic of device size
    }
  }

  if ($(bgImg[i]).attr('alt') == '') {
    // if alt attr is empty
...
if (settings.controls) {
  ...
  $(".prev").click(function () {
    ...
    if (totalWidth == 0) {
      ...
      $('.slider__roller').transition({
        translate: "-".concat(totalWidth, "px"),
        delay: 200
      }, 0); // Transition to last img

      if (settings.blurbg == true) {
        // If blur BG is on
        $('.bg-scroller').transition({
          translate: "-".concat(totalWidth, "px"),
          delay: 200
        }, 0); // Transition BG to last img
      }
      ...
      $('#current').text(current);
      $('.slider__roller').transition({
        translate: "+=".concat(widthInPx)
      }); // Transition to prev img

      if (settings.blurbg == true) {
        // If blur BG is on
        $('.bg-scroller').transition({
          translate: "+=".concat(widthInPx)
        }); // Transition BG to prev img
      }
    }
  }); // Next controls
  ...
  $(".next").click(function () {
    ...
    if (totalWidth >= $('.slider img').length * width) {
      // If on last image
      $('.slider__roller').transition({
        translate: "0px",
        delay: 200
      }, 0); // Reset transition to first img
      ...
      // If not on last image
      $('.slider__roller').transition({
        translate: "-=".concat(widthInPx)
      }); // Transition to next img
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","jquery.transit":"../node_modules/jquery.transit/jquery.transit.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
